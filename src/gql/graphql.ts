...
export type AddNoteMutation = {
  __typename?: "Mutation";
  updateNote: { __typename?: "UpdateNoteOutput"; message: string };
};
...
export type GetAllTagsQuery = {
  ...
  tags: {
    ...
    tags: Array<{
      __typename?: "KeyValuePairOfStringAndNoteTags";
      key: string;
      value: { __typename?: "NoteTags"; name?: string | null };
    }>;
  };
};
...
export type GetTagsOnFilterQuery = {
  __typename?: "Query";
  tags: {
    __typename?: "GetTagsOutput";
    tags: Array<{
...
export type GetNoteInBatchQuery = {
  __typename?: "Query";
  notes: {
    __typename?: "GetNotesOutput";
    notes: Array<{
  ...
  definitions: [
    {
      ...
      variableDefinitions: [
          ...
          type: {
            ...
            type: {
              ...
              type: {
                ...
                type: {
                  kind: "NamedType",
                  name: { kind: "Name", value: "NoteTagsInput" },
                },
              },
            },
          },
        ...
        },
        {
          ...
          variable: {
            kind: "Variable",
            name: { kind: "Name", value: "primaryTags" },
          },
          type: {
            kind: "ListType",
            type: {
        ...
        },
        {
          ...
          type: {
            ...
            type: {
              ...
              type: {
                kind: "NamedType",
                name: { kind: "Name", value: "NoteInputsInput" },
              },
            },
          },
        },
            ...
            arguments: [
              {
                ...
                value: {
                  ...
                  fields: [
                    {
                      kind: "ObjectField",
                      name: { kind: "Name", value: "batchSize" },
                      value: {
                        kind: "Variable",
...
export const GetTagsOnFilterDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getTagsOnFilter" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "size" } },
  ...
  GetTagsOnFilterQuery,
  GetTagsOnFilterQueryVariables
>;
export const GetNoteInBatchDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getNoteInBatch" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
          variable: { kind: "Variable", name: { kind: "Name", value: "size" } },
...
} as unknown as DocumentNode<GetNoteInBatchQuery, GetNoteInBatchQueryVariables>;
